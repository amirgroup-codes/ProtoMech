...
1. Download the families.tar.gz file from our [HuggingFace](https://huggingface.co/datasets/anonymous-hf-user/ProtoMechCircuits).
...
1. Download the functions.tar.gz file from our [HuggingFace](https://huggingface.co/datasets/anonymous-hf-user/ProtoMechCircuits).
...
**Purpose:** Computes Top-K activated sequences for every latent across all layers of the CLT model. Used for dataset-wide analysis. The results of this have already been saved in `top10_activations.pt` (which can be downloaded [here](https://huggingface.co/datasets/anonymous-hf-user/ProtoMechData/blob/main/top10_activations.pt)), but feel free to change it or run it again.
