...
- `01_extract_embeddings.py`: Extracts and caches ESM-2 embeddings for protein families from InterPro annotations
...
Uses InterPro family annotations to create positive/negative classification datasets for each family, with balanced sampling and train/validation/test splits. You can find the family data
at: https://huggingface.co/datasets/anonymous-hf-user/ProtoMechCircuits/blob/main/families.tar.gz 
(unzip first)